...
function setBlocked(kind) {
  ...
  const said = {
    ...
    throttled: `<b>업비트가 지금 우리 요청을 막고 있습니다.</b>
      ...
      <span class="dim"><b>지금은 앱이 일부러 조용히 있습니다.</b> 막혀 있는 동안
      계속 두드리면 차단이 오히려 길어지기 때문입니다. 아무것도 안 보내면서
      1분 → 2분 → 5분 → 10분으로 간격을 늘려 가며 스스로 다시 시도합니다.
      <b>버튼을 여러 번 누르면 오히려 늦어집니다</b> — 눌러도 보내지 않고 남은
